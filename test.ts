...
removeSongs([{ song_id: 2, song_name: 'song_name', song_artist: 'artist_name', position: 1 }, { song_id: 3, song_name: "song_name", song_artist: "artist_name", position: 2 }]);
console.log("Queue after removing a song by ID and position:", getQueue(), `, Expected: [{ song_id: 4, song_name: "song_name", song_artist: "artist_name", position: 1 }]`);
...
console.log("Queue remains:", getQueue(), `, Expected: [{ song_id: 4, song_name: "song_name", song_artist: "artist_name", position: 1 }]`);
